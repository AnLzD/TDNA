package com.group_8.app.reminder.view;
...
import com.group_8.app.reminder.activity.CameraActivity;
...
public class CameraPreview implements SurfaceHolder.Callback {
	...
	private boolean enableTakePic = true;
	...
	private float ratioImg;

	/**
	 * Called when the activity is first created.
	 */

	public CameraPreview(CameraActivity cameraActivity, CameraSurfaceView cameraSurfaceView) {
		...
		drawingView = new DrawingView(cameraActivity);
	...
	AutoFocusCallback autoFocusCallback = new AutoFocusCallback() {
		...
		public void onAutoFocus(boolean arg0, Camera arg1) {
			...
			info("Optimal Focus Distance(meters): " + focusDistances[Parameters.FOCUS_DISTANCE_OPTIMAL_INDEX]);
	...
	PictureCallback picCallback_JPG = new PictureCallback() {
		...
		private Camera.Size getBestPreviewSize(int width, int height, Parameters parameters) {
		...
		private Camera.Size getBestPictureSize(Parameters parameters, float ratio) {
			Camera.Size result = null;
